...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Game = __webpack_require__(395);
	...
	_reactDom2.default.render(_react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(_reactRouter.Route, { path: '/room/:gameId', component: _Game2.default })
			)
		)
		...
		(0, _createClass3.default)(App, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.cloneElement(children, (0, _extends3.default)({}, others))
				);
			}
		}]);
		return App;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(294).Object.getPrototypeOf;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var setToStringTag = __webpack_require__(351);
	var getPrototypeOf = __webpack_require__(331);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(297)(IteratorPrototype, __webpack_require__(352)('iterator'), function () { return this; });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var hide = __webpack_require__(297);
	var Iterators = __webpack_require__(346);
	var TO_STRING_TAG = __webpack_require__(352)('toStringTag');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var setToStringTag = __webpack_require__(351);
	var uid = __webpack_require__(322);
	var wks = __webpack_require__(352);
	var wksExt = __webpack_require__(357);
	var wksDefine = __webpack_require__(362);
	...
	var $GOPD = __webpack_require__(367);
	var $GOPS = __webpack_require__(324);
	var $DP = __webpack_require__(298);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var toIObject = __webpack_require__(311);
	var gOPN = __webpack_require__(366).f;
	var toString = {}.toString;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _setPrototypeOf = __webpack_require__(372);

	var _setPrototypeOf2 = _interopRequireDefault(_setPrototypeOf);

	var _create = __webpack_require__(376);
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function (test, buggy, set) {
	      try {
	        set = __webpack_require__(295)(Function.call, __webpack_require__(367).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.setGameState = exports.fetchGame = undefined;
	...
	var fetchGame = exports.fetchGame = function fetchGame(gameId, uid) {
		return function (dispatch) {
			(0, _api2.default)('/api/room/' + gameId + '?uid=' + uid).then(function (json) {
				return dispatch({ type: 'get_game', data: json });
			});
		};
	};

	var setGameState = exports.setGameState = function setGameState(uid, gameId, state) {
		return function (dispatch) {
			(0, _api2.default)('/api/room/' + gameId + '?uid=' + uid, {
				method: 'put',
				headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _handleAction = __webpack_require__(384);

	var _handleAction2 = _interopRequireDefault(_handleAction);

	var _handleActions = __webpack_require__(391);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _fluxStandardAction = __webpack_require__(385);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _lodashIsplainobject = __webpack_require__(386);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ownKeys = __webpack_require__(392);

	var _ownKeys2 = _interopRequireDefault(_ownKeys);

	var _reduceReducers = __webpack_require__(393);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _slicedToArray2 = __webpack_require__(399);
	...
	var _uid = __webpack_require__(412);
	...
	var _ChooseCard = __webpack_require__(413);

	var _ChooseCard2 = _interopRequireDefault(_ChooseCard);

	var _Cell = __webpack_require__(416);

	var _Cell2 = _interopRequireDefault(_Cell);

	var _Toast = __webpack_require__(417);
	...
	var Game = function (_Component) {
		...
		function Game(props) {
			...
			_this.uid_ = (0, _uid2.default)();
			_this.state = { cardOptions: [] };
			_this.highlightLocation_ = _this.highlightLocation_.bind(_this);
			_this.socket_ = _this.setupSocket();
			return _this;
		}
		...
		(0, _createClass3.default)(Game, [{
			...
			value: function setupSocket() {
				...
				socket.on('client_update_game', function (_ref) {
					var id = _ref.id,
					    card = _ref.card,
					    coord = _ref.coord;

					if (_this2.props.id !== id) {
						console.log('refresh_board');
						_this2.componentDidMount();
						_this2.highlightLast_(coord);
					}
					_this2.refs.historyBox.onMessage({
						message: card,
						type: 'update',
						id: id
					});
				});
				socket.on('client_update_chat', function (data) {
					console.log('socket_client_update_chat', data);
					_this2.refs.historyBox.onMessage(data);
				});
			...
			key: 'highlightLast_',
			value: function highlightLast_(_ref2) {
				var _ref3 = (0, _slicedToArray3.default)(_ref2, 2),
				    x = _ref3[0],
				    y = _ref3[1];

				try {
					var cl = _styles2.default['lhover'];
					var el = document.querySelectorAll('.' + _styles2.default['board'] + ' tr')[x].querySelectorAll('td')[y];
					el.classList.add(cl);
					setTimeout(function () {
			...
			key: 'broadCastMove',
			value: function broadCastMove(card, coord) {
				var _this3 = this;

				console.log('socket_server_play');
				setTimeout(function () {
					return _this3.socket_.emit('server_play', {
						id: _this3.props.id,
						card: card,
						coord: coord
					});
			...
			value: function broadCastMessage(_ref4) {
				var _this4 = this;
				...
				setTimeout(function () {
					return _this4.socket_.emit('server_chat', {
						id: _this4.props.id,
						type: type,
						message: message
					});
			...
			key: 'allowedToPlay',
			value: function allowedToPlay() {
				var _props$current = this.props.current,
				    id = _props$current.id,
				    start = _props$current.start;

				return String(id) === String(this.props.id) && !this.isTimedOut_(start);
			}
		}, {
			key: 'canPlayCard',
			value: function canPlayCard(card, isFilled, slot) {
				var isAlreadyPartOfSequence = (0, _sequence.isPartOfSequence)(this.props.board, slot);
				return this.props.hands.filter(function (handCard) {
					if (isFilled) {
			...
			value: function getPlayableCards(cellId) {
				var selectedCard = _cardmap2.default[cellId];
				var x = Math.floor(cellId / 10);
				var y = cellId % 10;
				var slotFilled = Boolean(this.props.board[x][y]);
				return this.canPlayCard(selectedCard, slotFilled, [x, y]);
			}
		}, {
			key: 'commitPlay',
			value: function commitPlay(cellId) {
				if ([0, 9, 90, 99].includes(cellId)) {
					return;
				}
				var x = Math.floor(cellId / 10);
				var y = cellId % 10;
				var playableCards = this.getPlayableCards(cellId);
			...
			key: 'chooseCardsOnConflict',
			value: function chooseCardsOnConflict(playableCards, slot) {
				this.setState({ cardOptions: playableCards, slot: slot });
			}
		}, {
			key: 'dropHand_',
			value: function dropHand_(card, _ref5) {
				var _ref6 = (0, _slicedToArray3.default)(_ref5, 2),
				    x = _ref6[0],
				    y = _ref6[1];

				var skipTurn = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
				var _props = this.props,
				    deck = _props.deck,
				    board = _props.board,
				    order = _props.order,
				...
				var myIndex = order.findIndex(function (v) {
					return String(v) === String(id);
				});
				var nextIndex = myIndex >= order.length - 1 ? 0 : myIndex + 1;

				console.log('drophand', card, [x, y]);

				if (skipTurn === false) {
					var pickedCard = deck.splice(0, 1);
					board[x][y] = card === '11_s' || card === '11_h' ? null : { id: id };
			...
			value: function onTimeOut() {
				...
				if (current.id === id) {
					...
					var theirIndex = order.findIndex(function (v) {
						return String(v) === String(current.id);
					});
					var nextIndex = theirIndex >= order.length - 1 ? 0 : theirIndex + 1;
					this.setNextState({
						current: {
							id: order[nextIndex],
							iteration: current.iteration + 1,
			...
			value: function render() {
				...
				if (loading) {
					return _react2.default.createElement(Error, { message: 'loading...' });
				} else if (loading === false && !game) {
					return _react2.default.createElement(Error, { message: 'Invalid game id' });
				}

				var myColor = this.getColor_(id);
				var counter = -1;

				return _react2.default.createElement(
					'div',
					{ className: (0, _classnames2.default)(_styles2.default['game']) },
					_react2.default.createElement(
						'table',
						{ className: _styles2.default['board'] },
						_react2.default.createElement(
							'tbody',
							null,
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							{
								className: (0, _classnames2.default)(this.isMyTurn() && [_styles2.default['alert'], _styles2.default[myColor]], _styles2.default['control']) },
							_react2.default.createElement(
								'a',
								{
									href: 'javascript:void(0)',
									className: _styles2.default['highlightall'],
							...
							_react2.default.createElement(
								'ul',
								{ className: _styles2.default['hand'] },
								hands.map(function (c, i) {
									return _react2.default.createElement(
										'li',
										{
											key: i,
							...
							_react2.default.createElement(
								...
								(0, _keys2.default)(players).map(function (player, i) {
									return _react2.default.createElement(
										'li',
										{
											key: i,
											className: (0, _classnames2.default)(current.id === player && _styles2.default['current']) },
							...
							_react2.default.createElement(
								'div',
								{ className: _styles2.default['players-container'] },
								_react2.default.createElement(
									'h3',
					...
					_react2.default.createElement(_ChooseCard2.default, {
						options: this.state.cardOptions,
						onClose: this.resolveConflictedCard.bind(this)
					}),
					this.state.message ? _react2.default.createElement(_Toast2.default, { message: this.state.message }) : null
				);
			}
		}, {
			key: 'isTimedOut_',
			value: function isTimedOut_(start) {
				var now = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : new Date().getTime();

				return now - start > _constants.timeoutMs;
			}
		}, {
			key: 'isMyTurn',
			...
			key: 'highlightLocation_',
			value: function highlightLocation_(inside, card, cellId) {
				var sel = '.' + _styles2.default['board'] + ' .' + _styles2.default['card_' + card];
				var els = document.querySelectorAll(sel);
				var cls = void 0;
				if (cellId > -1) {
					cls = '' + _styles2.default['chover'];
					...
					cls = '' + _styles2.default['hover'];
					inside ? els.forEach(function (el) {
						return el.classList.add(cls);
					}) : els.forEach(function (el) {
						return el.classList.remove(cls);
					});
			...
			key: 'highlightAll_',
			value: function highlightAll_(mousein) {
				this.props.hands.forEach(function (hand) {
					var sel = document.querySelectorAll('.' + _styles2.default['board'] + ' .' + _styles2.default['card_' + hand]);
					sel.forEach(function (e) {
						if (mousein) e.classList.add('' + _styles2.default['hover']);else e.classList.remove('' + _styles2.default['hover']);
					});
				});
			}
		}, {
			key: 'getColor_',
			value: function getColor_(id) {
				var _props4 = this.props,
				    teams = _props4.teams,
				    players = _props4.players;
	...
	var Avatar = function Avatar(_ref7) {
		...
		return _react2.default.createElement(
			'div',
			{
				className: (0, _classnames2.default)(_styles2.default['avatar-box'], current && _styles2.default['avatar-current'], !online && _styles2.default['avatar-online']) },
			_react2.default.createElement('img', {
				src: 'https://moma-teams-photos.corp.google.com/photos/' + id + '?sz=64',
				title: id,
				alt: id.slice(0, 4),
				className: (0, _classnames2.default)(_styles2.default['avatar'], _styles2.default['avatar-' + color])
			})
		);
	};

	var Error = function Error(props) {
		return _react2.default.createElement(_Toast2.default, { message: props.message || 'something went wrong.' });
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _isIterable2 = __webpack_require__(400);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ITERATOR = __webpack_require__(352)('iterator');
	var Iterators = __webpack_require__(346);
	module.exports = __webpack_require__(294).isIterable = function (it) {
	  var O = Object(it);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var anObject = __webpack_require__(299);
	var get = __webpack_require__(407);
	module.exports = __webpack_require__(294).getIterator = function (it) {
	  var iterFn = get(it);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.locals = {
		...
		"highlightall": "highlightall___1TA1H",
		"hover": "hover___10LXM",
		"chover": "chover___1-HWf",
		"card_new": "card_new___bNunR",
		"zoom": "zoom___1ABHb",
		"music_player": "music_player___1k2gG",
		"card_open": "card_open___2c6wm",
		"card_1_c": "card_1_c___MiWzI",
		"card_2_c": "card_2_c___1_Q8g",
		"card_3_c": "card_3_c___2EZEQ",
		"card_4_c": "card_4_c___1wAed",
		"card_5_c": "card_5_c___3HWah",
		"card_6_c": "card_6_c___38IVz",
		"card_7_c": "card_7_c___12CFV",
		"card_8_c": "card_8_c___3wyhD",
		"card_9_c": "card_9_c___Z14Q5",
		"card_10_c": "card_10_c___2-rbC",
		"card_11_c": "card_11_c___3PPzC",
		"card_12_c": "card_12_c___3sMLM",
		"card_13_c": "card_13_c___3rGj7",
		"card_1_h": "card_1_h___3MF4N",
		"card_2_h": "card_2_h___iQ2yF",
		"card_3_h": "card_3_h___r1Hai",
		"card_4_h": "card_4_h___2S9F_",
		"card_5_h": "card_5_h___T52pm",
		"card_6_h": "card_6_h___VZGIo",
		"card_7_h": "card_7_h___1uW3W",
		"card_8_h": "card_8_h___3jeoq",
		"card_9_h": "card_9_h___36kgO",
		"card_10_h": "card_10_h___2KIch",
		"card_11_h": "card_11_h___1FLJ8",
		"card_12_h": "card_12_h___3uYH7",
		"card_13_h": "card_13_h___3Xrgs",
		"card_1_s": "card_1_s___-zfSt",
		"card_2_s": "card_2_s___2sxuu",
		"card_3_s": "card_3_s___veOMB",
		"card_4_s": "card_4_s___t8lki",
		"card_5_s": "card_5_s___1s2qU",
		"card_6_s": "card_6_s___1cW_q",
		"card_7_s": "card_7_s___2041l",
		"card_8_s": "card_8_s___1e_K8",
		"card_9_s": "card_9_s___3Y0BF",
		"card_10_s": "card_10_s___1y9FP",
		"card_11_s": "card_11_s___2oMoR",
		"card_12_s": "card_12_s___2Xjg_",
		"card_13_s": "card_13_s___2kKk-",
		"card_1_d": "card_1_d___2f0ML",
		"card_2_d": "card_2_d___x4wgy",
		"card_3_d": "card_3_d___2zzYh",
		"card_4_d": "card_4_d___2R4YB",
		"card_5_d": "card_5_d___AMkBh",
		"card_6_d": "card_6_d___w9xBd",
		"card_7_d": "card_7_d___1ilPd",
		"card_8_d": "card_8_d___2pz-t",
		"card_9_d": "card_9_d___YAbOf",
		"card_10_d": "card_10_d___12pRW",
		"card_11_d": "card_11_d___Qqddc",
		"card_12_d": "card_12_d___lRpHf",
		"card_13_d": "card_13_d___1bk1M",
		"overlay": "overlay___1dUV9",
		"popup": "popup___1pa36",
		...
		"lhover": "lhover___erylL",
		"chat-input": "chat-input___1dfqy",
		"speech-bubble": "speech-bubble___3CmhW",
		"fun-toggle": "fun-toggle___19yhi",
		"fun-messages": "fun-messages___1jYcS",
		"fun-message": "fun-message___142D9",
		"messages": "messages___2z42T",
		"message": "message___1GnVq"
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
		var uid = sessionStorage.getItem('__uid');
		while (!uid) {
			uid = prompt('Your ID');
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/prashanthanand/apps/seqgame/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "uid.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = function (props) {
		var content = _react2.default.createElement(
			'div',
			null,
			props.options.map(function (card) {
				return _react2.default.createElement('div', {
					className: (0, _classnames2.default)(_styles2.default['card'], _styles2.default['card_' + card]),
					onClick: function onClick() {
						return props.onClose(card);
					}
				});
			})
		);
		return props.options.length ? _react2.default.createElement(
			_Dialog2.default,
			{ title: 'Pick one of your cards' },
			content
		) : null;
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = function (props) {
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				'div',
				{ className: _styles2.default['popup'] },
				_react2.default.createElement(
					'h2',
					null,
					props.title
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = function (props) {
		var color = props.color,
		    others = (0, _objectWithoutProperties3.default)(props, ['color']);

		return _react2.default.createElement(
			'td',
			others,
			_react2.default.createElement('div', {
				className: (0, _classnames2.default)(color && [_styles2.default['coin'], _styles2.default['coin-' + color]])
			})
		);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = function (props) {
		return _react2.default.createElement(
			'div',
			{ className: _styles2.default['toast'] },
			props.message
		);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Timer = function (_Component) {
		...
		function Timer(props) {
			...
			_this.state = {
				pendingSeconds: Math.round((_constants.timeoutMs - (new Date().getTime() - props.start)) / 1000)
			};
			return _this;
		}
		...
		(0, _createClass3.default)(Timer, [{
			...
			value: function componentDidMount() {
				...
				this.intv_ = setInterval(function () {
					var pendingSeconds = _this2.state.pendingSeconds;
					if (pendingSeconds <= 0) {
						clearInterval(_this2.intv_);
						_this2.props.onTimeout();
						return;
					}
					_this2.setState({ pendingSeconds: pendingSeconds - 1 });
				}, 1000);
			}
		}, {
			...
			value: function componentWillReceiveProps(nextProps) {
				...
				this.setState({
					pendingSeconds: Math.round((_constants.timeoutMs - (new Date().getTime() - nextProps.start)) / 1000)
				});
			...
			key: 'render',
			value: function render() {
				var pendingSeconds = this.state.pendingSeconds;
				pendingSeconds = Math.max(pendingSeconds, 0);
				var pendingMins = Math.floor(pendingSeconds / 60);
	...
	var History = function (_Component) {
		...
		(0, _createClass3.default)(History, [{
			...
			value: function sendMessage(type, message) {
				this.props.onSend({ type: type, message: message });
			}
		}, {
			key: 'onMessage',
			...
			key: 'parseMessage',
			value: function parseMessage(_ref2) {
				...
				if (type === 'funny') {
					return _react2.default.createElement(
						'div',
						{ className: _styles2.default['funny-message'] },
						id,
						' : ',
						message
					);
					...
					return _react2.default.createElement(
						'div',
						{ className: _styles2.default['normal-message'] },
						id,
						' : ',
						message
					);
					...
					return _react2.default.createElement(
						...
						_react2.default.createElement('div', {
							className: (0, _classnames2.default)(_styles2.default['card'], _styles2.default['card_' + message]) })
					);
				}
			}
		}, {
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ className: _styles2.default['history-container'] },
					_react2.default.createElement(
						'form',
					...
					_react2.default.createElement(
						...
						_react2.default.createElement('iframe', {
							...
							height: '100',
							ref: 'player',
							className: _styles2.default['music_player'],
							frameborder: '0',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function isPartOfSequence(board, _ref) {
		...
		var horizontal = horizontals(board, [x, y]);
		var vertical = verticals(board, [x, y]);
		var boardXLength = board.length;
		var boardYLength = board[0].length;
		var isHorizontalCorner = x === 0 || x === boardXLength - 1;
		var isVerticalCorner = y === 0 || y === boardYLength - 1;
		var hasWildcardNWDiagonal = x === y;
		var hasWildcardNEDiagonal = x + y === boardXLength - 1;

		return hasConsecutives(horizontal, isHorizontalCorner) || hasConsecutives(vertical, isVerticalCorner) || hasConsecutives(nortWestDiagonals(board, [x, y]), hasWildcardNWDiagonal) || hasConsecutives(northEastDiagonals(board, [x, y]), hasWildcardNEDiagonal);
	}

	function horizontals(board, _ref3) {
	...
	function verticals(board, _ref5) {
		var _ref6 = (0, _slicedToArray3.default)(_ref5, 2),
		    x = _ref6[0],
		    y = _ref6[1];
	...
	function nortWestDiagonals(board, _ref7) {
		...
		var px = x - 1,
		    py = y - 1;
		var northWestDiagonal = [board[x][y]];
		while (px >= 0 && py >= 0) {
	...
	function northEastDiagonals(board, _ref9) {
		...
		var px = x + 1,
		    py = y - 1;
		var northEastDiagonal = [board[x][y]];
	...
	function hasConsecutives(arr, isCorner) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = ['open', '2_s', '3_s', '4_s', '5_s', '10_d', '12_d', '13_d', '1_d', 'open', '6_c', '5_c', '4_c', '3_c', '2_c', '4_s', '5_s', '6_s', '7_s', '1_c', '7_c', '1_s', '2_d', '3_d', '4_d', '13_c', '12_c', '10_c', '8_s', '13_c', '8_c', '13_s', '6_c', '5_c', '4_c', '9_h', '8_h', '9_c', '9_s', '12_c', '9_c', '12_s', '7_c', '6_h', '5_h', '2_h', '7_h', '8_c', '10_s', '10_c', '1_s', '7_h', '9_d', '1_h', '4_h', '3_h', '13_h', '10_d', '6_h', '2_d', '13_s', '8_h', '8_d', '2_c', '3_c', '10_h', '12_h', '12_d', '5_h', '3_d', '12_s', '9_h', '7_d', '6_d', '5_d', '1_c', '1_d', '13_d', '4_h', '4_d', '10_s', '10_h', '12_h', '13_h', '1_h', '3_s', '2_s', '2_h', '3_h', '5_d', 'open', '9_s', '8_s', '7_s', '6_s', '9_d', '8_d', '7_d', '6_d', 'open'];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".root___3HMnk {\n\t\n}", "", {"version":3,"sources":["/./components/Home/style.css"],"names":[],"mappings":"AAAA;;CAEC","file":"style.css","sourcesContent":[".root {\n\t\n}"],"sourceRoot":"webpack://"}]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function configure(initialState) {
		...
		var createStoreWithMiddleware = (0, _redux.applyMiddleware)(logger, _reduxThunk2.default)(create);
